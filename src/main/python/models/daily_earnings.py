...
class DailyEarnings(BaseModel):
    ...
    date: date_type = Field(description="結算日期")
    ...
    settlement_timestamp: Optional[datetime_type] = Field(None, description="結算完成時間")
    created_at: datetime_type = Field(default_factory=datetime_type.now, description="創建時間")
